...
- [MDN Web Docs](https://developer.mozilla.org/en-US/)  
  Note: Online tutorial
- [Learning Web Design: A Beginner's Guide to HTML, CSS, JavaScript, and Web Graphics 4th Edition](https://wtf.tw/ref/robbins.pdf)
  Note: A comprehensive book on web design (jump to Part II: HTML MARKUP FOR STRUCTURE and Part III: CSS FOR PRESENTATION).
